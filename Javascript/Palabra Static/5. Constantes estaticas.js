class Persona
{
    ...
    constructor(nombre, apellido)
    {
        ...
        {
            console.error("Se ha superado el máximo de objetos permitidos");
        }
    }
...
console.log(Persona.MAX_OBJ); // Acceso a la constante estática MAX_OBJ
Persona.MAX_OBJ = 10;
console.log(Persona.MAX_OBJ); // Verifica el cambio de la constante estática